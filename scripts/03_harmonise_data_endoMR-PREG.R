...
message("Harmonisation settings: action = 2 (flag ambiguous palindromic SNPs).")
...
# Explicit filtering on mr_keep for clarity and reproducibility ---------------
dat <- dat[dat$mr_keep == TRUE, ]
message("Retained SNPs after mr_keep filtering: ", nrow(dat), " rows.")
